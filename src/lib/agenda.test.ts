...
describe("buildAgendaSchedule", () => {
  it("groups sessions and blocks per day, sorted by start", () => {
    const proposals = new Map<string, Proposal>([
      ["p", { id: "p", event_id: "e", attendee_id: null, proposer_name: "Ana", title: "STAC", description: "", format: null, duration_minutes: 60, hidden: false, pitched_in_review: false, created_at: "", custom_answers: {} }],
    ]);
